...
REM ====================================================
REM D-HCIS Payroll Start Menu shortcut installer
REM ====================================================

set APP_EXE=D:\HCIS\hcis_desktop_x64.exe
set APP_DIR=D:\HCIS
set STARTMENU=%APPDATA%\Microsoft\Windows\Start Menu\Programs\D-HCIS Payroll
...
echo.
echo Shortcut berhasil dibuat di Start Menu user.
